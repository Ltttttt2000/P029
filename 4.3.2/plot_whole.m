...
beta0 = 0.5;
delay = 0;
[t1,Eulerp,withoutpolicy,betas] = twothreshold1(tspan,p0,N, Ics,beta0,eplisons,delay);
...
p02 = [0.6; 0.4];
[t2,Eulerp2,withoutpolicy2,betas2] = twothreshold1(tspan,p02,N,Ics,beta0, eplisons,delay);

p03 = [0.8; 0.2];
[t3,Eulerp3,withoutpolicy3,betas3] = twothreshold1(tspan,p03,N,Ics,beta0, eplisons,delay);

p04 = [0.2, 0.5];
[t4,Eulerp4,withoutpolicy4,betas4] = twothreshold1(tspan,p04,N,Ics,beta0, eplisons,delay);

p05 = [0.4, 0.6];
[t5,Eulerp5,withoutpolicy5,betas5] = twothreshold1(tspan,p05,N,Ics,beta0, eplisons,delay);
