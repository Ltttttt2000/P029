...
% parameters = [0.2, 0.5, 0.5];
% parameters = [0.3, 0.5, 0.5];
% parameters = [0.35, 0.5, 0.5];
% parameters = [0.5, 0.5, 0.5];
% parameters = [0.7, 0.5, 0.5];
% 
% parameters = [0.4, 0.5, 0.2];
% parameters = [0.4, 0.5, 0.5];
% parameters = [0.4, 0.5, 0.7];
% 
% parameters = [0.4, 0.3, 0.5];
% parameters = [0.4, 0.5, 0.5];
% parameters = [0.4, 0.7, 0.5];
...
parameters = [0.2, 0.5, 0.5;
              ...
              0.5, 0.5, 0.5;
              0.6, 0.5, 0.5;
              0.7, 0.5, 0.5;  % change threshold Ic
              0.5, 0.3, 0.5;
              0.5, 0.4, 0.5;
              0.5, 0.5, 0.5;
              0.5, 0.6, 0.5;
              0.5, 0.7, 0.5;  % change beta
              0.5, 0.5, 0.3;
              0.5, 0.5, 0.4;
              0.5, 0.5, 0.5;
              0.5, 0.5, 0.6;
              0.5, 0.5, 0.7]; % change eplison
for A = 1:length(parameters)
    fprintf('%d\n', A);
    [t1,Eulerp,withoutpolicy,betas] = basicmodel(tspan,p0,N,parameters(A,1),parameters(A,2),parameters(A,3));
    figure;
    subplot(2,2,1);
    ...
    subplot(2,2,4);
    p02 = [0.6; 0.4];
    [t2,Eulerp2,withoutpolicy2,betas2] = basicmodel(tspan,p02,N,parameters(A,1),parameters(A,2),parameters(A,3));
    
    p03 = [0.8; 0.2];
    [t3,Eulerp3,withoutpolicy3,betas3] = basicmodel(tspan,p03,N,parameters(A,1),parameters(A,2),parameters(A,3));
    
    p04 = [0.2, 0.5];
    [t3,Eulerp4,withoutpolicy4,betas4] = basicmodel(tspan,p04,N,parameters(A,1),parameters(A,2),parameters(A,3));
    
    p05 = [0.4, 0.6];
    [t3,Eulerp5,withoutpolicy5,betas5] = basicmodel(tspan,p05,N,parameters(A,1),parameters(A,2),parameters(A,3));
