...
p06 = [0.2, 0.3];
[t6,Eulerp6,withoutpolicy6,betas6] = twothreshold2(tspan,p06,N,Ics,beta0, eplisons,0);

p07 = [0.4, 0.2];
[t7,Eulerp7,withoutpolicy7,betas7] = twothreshold2(tspan,p07,N,Ics,beta0, eplisons,0);
