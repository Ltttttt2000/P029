...
for k = 1:N   %time h:day
    ...
    if I < Ic1 && SminsI < Ic2     % 两个都不实行
        beta = 0.5;
        count1 = 0;
        count2 = 0;
        days0 =  days0 + 1;
    elseif I >= Ic1 && SminsI < Ic2 && count1 < delay  % 都不实行 超过了Ic1但是都不实行
        beta = 0.5;
        count1 = count1 + 1;
        count2 = 0;
        days1 =  days1 + 1;    
    ...
    elseif I < Ic1 && SminsI >= Ic2 && count2 < delay
        ...
        count2 = count2 +1;
        days0 = days0 + 1;
    elseif I < Ic1 && SminsI >= Ic2 && count2 >= delay   % only 2
    ...
    elseif I >= Ic1 && SminsI >= Ic2 && count1 < delay && count2 >= delay
        ...
        days2 = days2 + 1;         
    elseif I >= Ic1 && SminsI >= Ic2 && count1 >= delay && count2 >= delay
        beta = (1-f*eplison1)*(1-eplison2)*beta0;
        count1 = count1 + 1;
        count2 = count2 + 1;
        days3 = days3 + 1; 
    end
