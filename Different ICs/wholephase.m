...
p02 = [0.6; 0.4];
[t2,Eulerp2,withoutpolicy2,betas2] = twothreshold3(tspan,p02,N,Ics,beta0, eplisons,delay);

p03 = [0.8; 0.2];
[t3,Eulerp3,withoutpolicy3,betas3] = twothreshold3(tspan,p03,N,Ics,beta0, eplisons,delay);

p04 = [0.2, 0.5];
[t4,Eulerp4,withoutpolicy4,betas4] = twothreshold3(tspan,p04,N,Ics,beta0, eplisons,delay);

p05 = [0.4, 0.6];
[t5,Eulerp5,withoutpolicy5,betas5] = twothreshold3(tspan,p05,N,Ics,beta0, eplisons,delay);

p06 = [0.2, 0.2];
[t6,Eulerp6,withoutpolicy6,betas6] = twothreshold3(tspan,p06,N,Ics,beta0, eplisons,delay);

p07 = [0.2, 0.3];
[t7,Eulerp7,withoutpolicy7,betas7] = twothreshold3(tspan,p07,N,Ics,beta0, eplisons,delay);

p08 = [0.8, 0.5];
[t8,Eulerp8,withoutpolicy8,betas8] = twothreshold3(tspan,p08,N,Ics,beta0, eplisons,delay);

p09 = [0.6, 0.5];
[t9,Eulerp9,withoutpolicy9,betas9] = twothreshold3(tspan,p09,N,Ics,beta0, eplisons,delay);

p10 = [0.7, 0.8];
[t10,Eulerp10,withoutpolicy10,betas10] = twothreshold3(tspan,p10,N,Ics,beta0, eplisons,delay);
