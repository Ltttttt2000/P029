...
function [t,r,withoutpolicy,betachange,daysofpolicy, dayswithoutpolicy] = basicmodel_week(tspan,yI,N, Ic,beta0,eplison)
...
for k = 1:N   %time h:day
    ...
    fprintf('Week %d S0: %.2f I0: %.2f initial infected rate: %.2f S:%.2f I:%.2f infected rate:%.2f\n', ...
