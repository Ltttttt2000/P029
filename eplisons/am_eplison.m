...
for A = 0.1:steps:1.0
    ...
    [t1,Eulerp,withoutpolicy,betas,daysofpolicy,dayswithoutpolicy] = basicmodel_countdays(tspan,p0,N,threshold,beta0, A);

    susceptible = Eulerp(1,30:100);
    infected = Eulerp(2,30:100);
